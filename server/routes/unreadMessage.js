module.exports = function (io) {
    ...
    router.get('/:id', function (req, res, next) {
        UnreadMessage.find({
            userId: req.user._id, journeyId: req.params.id
    ...
    router.delete('/:id', function (req, res, next) {
        UnreadMessage.remove({userId: req.user._id, journeyId: req.params.id}, function (err, messages) {
            if (err) {
                return res.send({error: err});
            }
            res.send({removed: messages});
        })
    });
